...
import { LayersIcon, TagIcon, SparklesIcon, DatabaseIcon } from 'lucide-react'

export default function DataQualityCenter() {
  const [activeTab, setActiveTab] = useState<'dedup' | 'verify' | 'autolearn'>('dedup')
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="bg-white border-b border-slate-200 px-8 py-4 z-10 relative shadow-sm">
          <div className="max-w-7xl mx-auto flex flex-col gap-6">
            ...
            <div className="flex gap-4 p-1.5 bg-slate-100/80 rounded-[20px] w-fit">
              <button 
