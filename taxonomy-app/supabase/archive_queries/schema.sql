...
CREATE TABLE IF NOT EXISTS "public"."system_settings" (
    ...
    "ai" "jsonb" DEFAULT '{"maxTokens": 4000, "apiProvider": "local", "temperature": 0.1, "embeddingModel": "paraphrase-multilingual-MiniLM-L12-v2"}'::"jsonb",
...
CREATE POLICY "Allow public delete on imports" ON "public"."imports" FOR DELETE USING (true);



CREATE POLICY "Allow public delete on product_attributes" ON "public"."product_attributes" FOR DELETE USING (true);



CREATE POLICY "Allow public delete on product_category_suggestions" ON "public"."product_category_suggestions" FOR DELETE USING (true);



CREATE POLICY "Allow public insert on imports" ON "public"."imports" FOR INSERT WITH CHECK (true);



CREATE POLICY "Allow public insert on product_attributes" ON "public"."product_attributes" FOR INSERT WITH CHECK (true);



CREATE POLICY "Allow public insert on product_category_suggestions" ON "public"."product_category_suggestions" FOR INSERT WITH CHECK (true);



CREATE POLICY "Allow public insert on review_history" ON "public"."review_history" FOR INSERT WITH CHECK (true);



CREATE POLICY "Allow public insert on similarity_matches" ON "public"."similarity_matches" FOR INSERT WITH CHECK (true);



CREATE POLICY "Allow public select on imports" ON "public"."imports" FOR SELECT USING (true);



CREATE POLICY "Allow public select on product_attributes" ON "public"."product_attributes" FOR SELECT USING (true);



CREATE POLICY "Allow public select on product_category_suggestions" ON "public"."product_category_suggestions" FOR SELECT USING (true);



CREATE POLICY "Allow public select on review_history" ON "public"."review_history" FOR SELECT USING (true);



CREATE POLICY "Allow public select on similarity_matches" ON "public"."similarity_matches" FOR SELECT USING (true);



CREATE POLICY "Allow public update on imports" ON "public"."imports" FOR UPDATE USING (true);



CREATE POLICY "Allow public update on product_attributes" ON "public"."product_attributes" FOR UPDATE USING (true);



CREATE POLICY "Allow public update on product_category_suggestions" ON "public"."product_category_suggestions" FOR UPDATE USING (true);
