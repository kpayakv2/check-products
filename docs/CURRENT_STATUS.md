...
## 🔎 ผลตรวจ 9 หน้า (29 ส.ค. 2569) — **ยังไม่ได้แก้ นี่คือจุดรับงานต่อ**
...
## ⚠️ สถานะ git ตอนส่งต่อ (29 ส.ค. 2569)

**งานแก้บั๊ก wizard ทั้งหมดยังไม่ได้ commit — 24 ไฟล์ค้างอยู่ใน working tree**
รันเทสต์ผ่านแล้ว (jest 134 ผ่าน / tsc เหลือ 9 error ตาม baseline / พิสูจน์กับ DB จริงแล้ว)
แต่ตั้งใจไม่ commit เพราะเจ้าของงานยังไม่ได้สั่ง — **เซสชันถัดไปควรถามก่อนว่าจะ commit หรือแก้เพิ่ม**

migration `20260828000004` **apply ลง local DB ไปแล้ว** (index `imports_wizard_run_id_key` มีอยู่จริง)
ถ้าจะ reset DB ต้องรู้ว่า migration นี้ยังไม่ได้ commit เข้า git
