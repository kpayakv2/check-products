...
*Last Updated: 2026-08-29 (รอบสอง)*
...
**`/settings` อ่าน/เขียน `system_settings` ด้วย anon key ซึ่ง RLS ปิดไว้** — ยืนยันในเบราว์เซอร์แล้ว
ขึ้น `406` สองครั้งตอนโหลดหน้า แปลว่าหน้าตั้งค่าโชว์ค่า default และกดบันทึกก็ไม่ลง DB
วิธีแก้แบบเดียวกับ import history: ทำ API route ที่ใช้ service role
